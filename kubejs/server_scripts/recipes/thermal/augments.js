ServerEvents.recipes(event => {
    ...
    event.recipes.thermal.smelter(['2x thermal:machine_efficiency_augment'], ['2x #forge:plates/biobrass', 'biomancy:nutrient_paste', 'biomancy:bile'])
    event.recipes.thermal.smelter(['thermal:machine_speed_augment'], ['chestcavity:animal_heart', '2x #forge:plates/biobrass', 'biomancy:bile'])
    ...
    event.recipes.thermal.smelter(['thermal:machine_catalyst_augment'], ['chestcavity:animal_kidney', '2x #forge:plates/biobrass', 'biomancy:bile'])
    ...
    event.recipes.thermal.smelter(['thermal:dynamo_output_augment'], ['chestcavity:animal_stomach', '2x #forge:plates/chitinsteel', 'biomancy:bile'])
    event.recipes.thermal.smelter(['thermal:dynamo_fuel_augment'], ['chestcavity:animal_intestine', '2x #forge:plates/biobrass', 'biomancy:bile'])
