ServerEvents.recipes(event => {
    ...
    event.recipes.biomancy.bio_brewing(['biomancy:water_gel_block', 'biomancy:water_gel_block', 'chestcavity:aquatic_muscle', 'chestcavity:aquatic_muscle'], 'chestcavity:dragon_lung', 'kubejs:aquatic_lung', 200)
