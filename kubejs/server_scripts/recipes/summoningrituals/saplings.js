ServerEvents.recipes(event => {
    ...
    sapling_recipe('oak_sapling', 'minecraft:poppy', 'minecraft')
    sapling_recipe('spruce_sapling', 'minecraft:mossy_cobblestone', 'minecraft')
    sapling_recipe('birch_sapling', 'minecraft:grass', 'minecraft')
    sapling_recipe('jungle_sapling', 'minecraft:bamboo', 'minecraft')
    sapling_recipe('acacia_sapling', 'minecraft:dandelion', 'minecraft')
    sapling_recipe('dark_oak_sapling', '#forge:mushrooms', 'minecraft')
    sapling_recipe('mangrove_propagule', 'minecraft:mud', 'minecraft')
    sapling_recipe('cherry_sapling', '#forge:dyes/pink', 'minecraft')
    sapling_recipe('azalea', 'quark:moss_paste', 'minecraft')
    sapling_recipe('ancient_sapling', 'minecraft:netherite_scrap', 'quark')
    sapling_recipe('twisted_sapling', '#forge:dyes/purple', 'architects_palette')
    sapling_recipe('rubberwood_sapling', 'biomancy:nutrient_paste', 'thermal')
